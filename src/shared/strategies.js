...
export const allStrategyAssetMapping = {
  ...
  [EIGEN_STRATEGY]: {
    name: 'Eigen',
    symbol: 'EIGEN',
    logo: new URL('/eigen.webp', import.meta.url).href
  },
  [BEACON_STRATEGY]: {
    name: 'Beacon',
    symbol: 'ETH',
    logo: new URL('/eth.png', import.meta.url).href
  }
};
